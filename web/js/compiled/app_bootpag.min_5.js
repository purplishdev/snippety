    ...
    h.fn.bootpag = function(p) {
        ...
        var l = this,
            a = h.extend({
                ...
                prev: "&laquo;",
                firstLastUse: !1,
                first: '<span aria-hidden="true">Poprzednia</span>',
                last: '<span aria-hidden="true">Następna</span>',
        ...
        return this.each(function() {
            ...
            a.firstLastUse && (c = c.concat(['<li data-lp="1" class="page-item ', a.firstClass, '"><a href="', g(1), '">', a.first, "</a></li>"]));
            ...
            a.firstLastUse && (c = c.concat(['<li data-lp="', a.total, '" class="page-item last"><a href="', g(a.total), '">', a.last, "</a></li>"]));
            c.push("</ul>");
